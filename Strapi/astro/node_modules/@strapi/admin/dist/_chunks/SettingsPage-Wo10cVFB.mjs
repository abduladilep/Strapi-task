...
import { y as SETTINGS_LINKS_CE, p as useEnterprise, u as useConfiguration, d as createRoute } from "./index-qQynS5yD.mjs";
...
const ROUTES_CE = [
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-_4I8Oa-k.mjs").then((n) => n.b);
      return ProtectedEditPage;
    },

...
const CM = React.lazy(
  () => import("./index-qQynS5yD.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
...
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-JD39Vp_U.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-qQynS5yD.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);

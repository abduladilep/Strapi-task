...
const ListView$1 = lazy(() => import("./ListView-CSlWk6Gz.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-CSlWk6Gz.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-KDrN3h7y.mjs.map
